import { Component, Inject, NgZone, PLATFORM_ID, Input, AfterViewChecked} from '@angular/core';
...
export class ChartsFigureComponent implements AfterViewChecked {

  private chart: am4charts.XYChart | undefined;
  @Input('selectedOption') selectedOption:Option | undefined
